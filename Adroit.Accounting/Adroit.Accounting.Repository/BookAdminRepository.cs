...
namespace Adroit.Accounting.Repository
{
    public class BookAdminRepository : IBookAdmin
    {
        public int Save(BookAdmin value, string connectionString, int loginId = 0, int firmId = 0)
        {
            ...
            parameters.Add("@TDSAccountId", value.TDSAccountId);
            parameters.Add("@IsTCSAccount", value.IsTCSAccount);
            parameters.Add("@TCSAccountId", value.TCSAccountId);
            ...
            parameters.Add("@GSTStateCessAccountId", value.GSTStateCessAccountId);
            parameters.Add("@GSTCentralCessAccountId", value.GSTCentralCessAccountId);
            parameters.Add("@RCMSGSTPayAccountId", value.RCMSGSTPayAccountId);
            parameters.Add("@RCMCGSTPayAccountId", value.RCMCGSTPayAccountId);
            parameters.Add("@RCMIGSTPayAccountId", value.RCMIGSTPayAccountId);
            parameters.Add("@RCMSGSTRecAccountId", value.RCMSGSTRecAccountId);
            parameters.Add("@RCMCGSTRecAccountId", value.RCMCGSTRecAccountId);
            parameters.Add("@RCMIGSTRecAccountId", value.RCMIGSTRecAccountId);
