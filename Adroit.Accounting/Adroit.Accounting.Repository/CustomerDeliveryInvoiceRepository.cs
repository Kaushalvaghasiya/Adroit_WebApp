...
{
    public class CustomerDeliveryInvoiceRepository : ICustomerDeliveryInvoice
    {
        ...
        public bool Delete(int id, string connectionString, int loginId)
        {
            ...
            return QueryHelper.Delete("sp_CustomerDeliveryInvoiceDelete", connectionString, parameters);
        }
        ...
        public List<LRBookingGridViewModel> GetListByLRNumberId(string connectionString, int LRNumberId, int loginId, int branchId, int firmId, bool isAgency)
        {
            ...
            parameters.Add("@IsAgency", isAgency);
            return QueryHelper.GetList<LRBookingGridViewModel>("sp_DeliveryInvoiceLRBookingGetGridDetailsByLRNumber", connectionString, parameters);
        }
        public List<DropdownViewModel> GetCustomerAccountBranchMappingList_Select(int loginId, int firmId, int branchId, int payTypeId, string connectionString)
        {
            ...
            parameters.Add("@LoginId", loginId);
            return QueryHelper.GetList<DropdownViewModel>("sp_DeliveryInvoiceCustomerAccounListWithGroup_Select", connectionString, parameters);
        }
    }
}
