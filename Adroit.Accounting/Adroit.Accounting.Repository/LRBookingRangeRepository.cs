...
namespace Adroit.Accounting.Repository
{
    public class LRBookingRangeRepository : ILRBookingRange
    {
        ...
        public List<DropdownViewModel> SelectBranch(int userId, string connectionString)
        {
            var parameters = new DynamicParameters();
            parameters.Add("@UserId", userId);
            return QueryHelper.GetList<DropdownViewModel>("sp_LRBookingRangeBranch_Select", connectionString, parameters);
        }
    }
}