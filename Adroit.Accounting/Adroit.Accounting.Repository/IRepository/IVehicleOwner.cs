...
namespace Adroit.Accounting.Repository.IRepository
{
    public interface IVehicleOwner
    {
        ...
        int Save(VehicleOwner value, string connectionString);
        void Delete(int id, int customerId, string connectionString);
        VehicleOwnerViewModel Get(int id, int customerId, string connectionString);
