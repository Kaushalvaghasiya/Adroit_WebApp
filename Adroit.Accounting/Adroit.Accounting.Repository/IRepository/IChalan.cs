...
namespace Adroit.Accounting.Repository.IRepository
{
    public interface IChalan
    {
        ...
        List<DropdownViewModel> GetChalanNumberListBySenderId(string connectionString, int loginId, int firmId, int branchId, int senderId);
        List<DropdownViewModel> GetChalanListByBranchId_Select(string connectionString, int branchId);
    }
}
