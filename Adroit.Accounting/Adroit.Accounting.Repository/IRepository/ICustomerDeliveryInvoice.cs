...
{
    public interface ICustomerDeliveryInvoice
    {
        ...
        public List<LRBookingGridViewModel> GetListByLRNumberId(string connectionString, int lrNumberId, int loginId, int branchId, int firmId = 0, bool isAgency= false);
