...
namespace Adroit.Accounting.Repository.IRepository
{
    public interface IChalanReceive
    {
        ...
        public ChalanReceiveViewModel GetChalanMasterListByChalanNumber(string connectionString, int chalanNumber, int senderId, int loginId, int firmId = 0);
        public List<ChalanReceiveGridViewModel> GetChalanDetailListByChalanNumber(string connectionString, int chalanNumber, int senderId, int loginId, int firmId = 0);
    }
}
