...
namespace Adroit.Accounting.Repository.IRepository
{
    public interface ILRBooking
    {
        ...
        public List<LRBookingGridViewModel> GetListByCityFrom_To(string connectionString, int fromCityId, int toCityId, int branchId, int loginId, int firmId = 0, string search = "", int pageStart = 0, int pageSize = 10, int sortColumn = 0, string sortOrder = "ASC");
