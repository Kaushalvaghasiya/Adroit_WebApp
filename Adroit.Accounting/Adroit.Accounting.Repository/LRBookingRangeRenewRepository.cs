...
{
    public class LRBookingRangeRenewRepository : ILRBookingRangeRenew
    {
        public int Save(LRBookingRangeViewModel value, string connectionString)
        {
            ...
            return QueryHelper.Save("sp_LRBookingRangeRenewSave", connectionString, parameters);
        }
        public LRBookingRangeViewModel Get(int id, int firmId, string connectionString)
        {
            ...
            return QueryHelper.Get<LRBookingRangeViewModel>("sp_LRBookingRangeRenewGet", connectionString, parameters);
        }
