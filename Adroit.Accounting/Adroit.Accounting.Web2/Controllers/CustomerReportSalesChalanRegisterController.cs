...
namespace Adroit.Accounting.Web.Controllers
{
    ...
    {
        public IActionResult SalesChalanRegister()
        {
            SalesChalanRegisterViewModel model = new SalesChalanRegisterViewModel();
            ...
            model.ChalanType = GenericHelper.GetChalanTypeList();
