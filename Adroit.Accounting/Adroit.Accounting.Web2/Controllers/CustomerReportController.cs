...
namespace Adroit.Accounting.Web.Controllers
{
    public partial class CustomerReportController : MasterController
    {
        ...
        private readonly IChalanLoadingReport _chalanLoadingReportRepository;
        ...
        public CustomerReportController(
            ...
            IChalanLoadingReport chalanLoadingReportRepository)
            : base(loginHandler, userRepository, configurationData)
        {
            ...
            _chalanLoadingReportRepository = chalanLoadingReportRepository;
        }
