    ...
    public partial class CustomerController : Controller
    {
        ...
        public JsonResult ProductDesignNumberList(int draw = 0, int start = 0, int length = 10, int customerId = 0)
        {
            ...
            try
            {
                ...
                var records = _productDesignNumberRepository.List(_configurationData.DefaultConnection, loginId, firmId, search, start, length, sortColumn, sortDirection).ToList();
                result.data = records;
