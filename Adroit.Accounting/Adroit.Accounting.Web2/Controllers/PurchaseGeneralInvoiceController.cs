...
namespace Adroit.Accounting.Web.Controllers
{
    ...
    {
        public IActionResult PurchaseGeneralInvoice()
        {
        ...
        public IActionResult PurchaseGeneralInvoice2()
        {
            var model = new PurchaseBillMasterViewModel();
            model.BillTypeList = _billTypeAdminRepository.GetBillTypeAdminList(_configurationData.DefaultConnection, CurrentUserId, CurrentFirmId);
            model.BookBranchList = _customerBookRepository.SelectListByBookType(CurrentBranchId, BookTypeList.Purchase.DescriptionAttr(), _configurationData.DefaultConnection);
        ...
        [Route("~/Customer/GetBookSettings/{bookMappingId}")]
        public JsonResult GetBookSettings(int bookMappingId)
        {
            ApiResult result = new ApiResult();
            try
            {
                CustomerBook CustomerBook = _customerBookRepository.GetWithCustomerBookBranchMapping(bookMappingId, _configurationData.DefaultConnection, CurrentUserId, CurrentBranchId);
        ...
        [HttpGet]
        public JsonResult PurchaseGeneralInvoiceList(int draw = 0, int start = 0, int length = 10)
        {
            ...
            try
            {
                ...
                var records = _customerPurchaseGeneralInvoiceRepository.List(_configurationData.DefaultConnection, CurrentUserId, CurrentBranchId, CurrentFirmId, search, start, length, sortColumn, sortDirection).ToList();
                result.data = records;
        ...
        [HttpPost]
        public JsonResult SavePurchaseGeneralInvoice([FromBody] PurchaseBillMasterViewModel model)
        {
            ApiResult result = new ApiResult();
            try
            {
                ...
                int id = _customerPurchaseGeneralInvoiceRepository.Save(model, _configurationData.DefaultConnection);
                if (id > 0)
                {
                    result.data = true;
                    result.result = Constant.API_RESULT_SUCCESS;
        ...
        public JsonResult DeletePurchaseGeneralInvoice(int id)
        {
            ApiResult result = new ApiResult();
            try
            {
        ...
        public JsonResult GetPurchaseBillDetailListByPurchaseBillMasterId(int id)
        {
            ...
            try
            {
                var data = _customerPurchaseGeneralInvoiceRepository.GetPurchasebillDetailListByPurchaseBillMasterId(_configurationData.DefaultConnection, id, CurrentBranchId, CurrentUserId);
                result.data = data;
                result.result = Constant.API_RESULT_SUCCESS;
            }
            catch (Exception ex)
