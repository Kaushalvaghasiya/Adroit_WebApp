    ...
    public partial class CustomerController : MasterController
    {
        ...
        public JsonResult CustomerFirmBranchLRRateList(int draw = 0, int start = 0, int length = 10, int firmId = 0)
        {
            ...
            try
            {
                ...
                var records = _customerFirmBranchLRRateRepository.List(_configurationData.DefaultConnection, CurrentUserId, firmId, search, start, length, sortColumn, sortDirection).ToList();
                result.data = records;
