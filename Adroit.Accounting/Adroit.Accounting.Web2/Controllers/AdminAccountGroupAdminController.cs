...
namespace Adroit.Accounting.Web.Controllers
{
    public partial class AdminController : Controller
    {
        public IActionResult AccountGroupAdmin()
        {
            ...
            //model.AccountGroupHeaderList = _accountGroupHeader.SelectList(_configurationData.DefaultConnection);
        ...
        public JsonResult AccountGroupAdminList(int draw = 0, int start = 0, int length = 10, int customerId = 0)
        {
            ...
            try
            {
                ...
                var records = _accountGroupAdminRepository.List(_configurationData.DefaultConnection, loginId, firmId, search, start, length, sortColumn, sortDirection).ToList();
                result.data = records;
