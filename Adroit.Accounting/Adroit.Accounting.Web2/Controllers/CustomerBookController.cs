...
namespace Adroit.Accounting.Web.Controllers
{
    public partial class CustomerController : Controller
    {
        public IActionResult Book()
        {
            ...
            model.CustomerAccountList = _customerAccountRepo.GetCustomerAccountListWithAccountGroup(_configurationData.DefaultConnection, loginId, CurrentFirmId);
            model.BookTypeList = _bookTypeRepository.GetBookTypeAdminList(_configurationData.DefaultConnection, loginId, CurrentFirmId);
            model.BillTypeList = _billTypeAdminRepository.GetBillTypeAdminList(_configurationData.DefaultConnection, loginId, CurrentFirmId);
            model.BillFromList = _salesBillFromAdminRepository.SalesBillFromAdminList(_configurationData.DefaultConnection, loginId, CurrentFirmId);
