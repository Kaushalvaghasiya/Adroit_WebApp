...
BEGIN
	...
	(SELECT CCA1.Name FROM CustomerFirmBranchTransportSetting CFT1
		...
		WHERE CFT1.BranchId = PBM.BranchId) AS ToPayAccountLabel,
	(SELECT CCA2.Name FROM CustomerFirmBranchTransportSetting CFT2
		...
		WHERE CFT2.BranchId = PBM.BranchId) AS CrossingAmountAccountLabel,
	(SELECT CCA3.Name FROM CustomerFirmBranchTransportSetting CFT3
		...
		WHERE CFT3.BranchId = PBM.BranchId) AS CrossingCommissionAccountLabel,
	(SELECT CCA4.Name FROM CustomerFirmBranchTransportSetting CFT4
		...
		WHERE CFT4.BranchId = PBM.BranchId) AS CrossingHamaliAccountLabel,
	(SELECT CCA5.Name FROM CustomerFirmBranchTransportSetting CFT5
		...
		WHERE CFT5.BranchId = PBM.BranchId) AS CrossingDeliveryChargeAccountLabel,
