...
BEGIN
	...
	AND LB1.Id IN (SELECT Id FROM [dbo].[fnStringToIntArray](@LRNumberId))
	...
	AND LB2.Id IN (SELECT Id FROM [dbo].[fnStringToIntArray](@LRNumberId))
	...
	AND LB3.Id IN (SELECT Id FROM [dbo].[fnStringToIntArray](@LRNumberId))
